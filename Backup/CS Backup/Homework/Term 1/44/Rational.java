...
// Team Triple (Kevin Feng, Tim Marder, Kyle Tau)
// Tim Marder
// APCS1 p2
...
public class Rational implements Comparable
{
	...
	if (other instanceof Rational) {
	    if ((this._numerator == ((Rational)other)._numerator)
	...
	if (!(other instanceof Rational)) {
		throw new ClassCastException("The input is not an instance of class Rational.");}
	else {
